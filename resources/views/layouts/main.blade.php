...
<head>
    ...
    <!-- Vendor CSS -->
    <link href="{{ asset('') }}template/assets/vendors/dataTables/dataTables.bootstrap5.min.css" rel="stylesheet">
    <link href="{{ asset('') }}template/assets/vendors/select2/select2.min.css" rel="stylesheet">
    <link href="{{ asset('') }}template/assets/vendors/select2/select2-bootstrap-5-theme.min.css" rel="stylesheet">
    <link href="{{ asset('') }}template/assets/vendors/toastr/build/toastr.min.css" rel="stylesheet">
    <link href="{{ asset('') }}template/assets/vendors/sweetalert2/dist/sweetalert2.min.css" rel="stylesheet">
    @stack('style')
</head>
...
<body>
    ...
    <script src="{{ asset('') }}template/assets/vendors/dataTables/jquery.dataTables.js"></script>
    <script src="{{ asset('') }}template/assets/vendors/dataTables/dataTables.bootstrap5.min.js"></script>
    <script src="{{ asset('') }}template/assets/vendors/select2/select2.full.min.js"></script>
    ...
    <script src="{{ asset('') }}template/assets/vendors/ckeditor5/ckeditor.js"></script>
