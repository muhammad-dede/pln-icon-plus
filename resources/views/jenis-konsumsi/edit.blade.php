...
@section('title', 'Ubah Jenis Konsumsi')
        ...
        <div class="container-xl">
            <div class="row justify-content-center">
                <div class="col-xl-10 col-lg-10">
                    <form id="form_submit" action="{{ route('jenis-konsumsi.update', $jenis_konsumsi) }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="card">
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" name="nama"
                                            ...
                                            value="{{ old('nama') ?? $jenis_konsumsi->nama }}" />
                                        @error('nama')
                                    ...
                                    <div class="col-md-9 col-12">
                                        <select name="id_waktu_meeting"
                                            ...
                                            @foreach (waktuMeeting() as $item)
                                                <option value="{{ $item->id }}" @selected(old('id_waktu_meeting') == $item->id || $jenis_konsumsi->id_waktu_meeting == $item->id)>
                                                    {{ $item->nama }}
                                                </option>
                                            @endforeach
                                        </select>
