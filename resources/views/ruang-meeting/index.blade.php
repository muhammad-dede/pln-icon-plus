                ...
                <div class="card-header">
                    ...
                    <div class="card-actions">
                        @can('create-ruang-meeting')
                            <a class="btn-link text-primary mx-2" href="{{ route('ruang-meeting.create') }}">
                                Tambah
                            </a>
                        @endcan
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @can('edit-ruang-meeting')
                                                <a class="btn-link text-info" href="{{ route('ruang-meeting.edit', $item) }}">
                                                    Ubah
                                                </a>
                                            @endcan
                                        </td>
                                        <td>
                                            @can('destroy-ruang-meeting')
                                                <form action="{{ route('ruang-meeting.destroy', $item) }}" method="POST">
                                                    @csrf
                                                    @method('delete')
                                                    <a class="btn-link text-danger btn_delete"
                                                        href="{{ route('ruang-meeting.destroy', $item) }}"
                                                        data-item="{{ $item->nama ?? '-' }}">
                                                        Hapus
                                                    </a>
                                                </form>
