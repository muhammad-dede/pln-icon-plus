...
@section('title', 'Ubah Ruang Meeting')
        ...
        <div class="container-xl">
            <div class="row justify-content-center">
                <div class="col-xl-10 col-lg-10">
                    <form id="form_submit" action="{{ route('ruang-meeting.update', $ruang_meeting) }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="card">
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" name="nama"
                                            ...
                                            value="{{ old('nama') ?? $ruang_meeting->nama }}" />
                                        @error('nama')
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="number" name="kapasitas"
                                            ...
                                            value="{{ old('kapasitas') ?? $ruang_meeting->kapasitas }}" />
                                        @error('kapasitas')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
