...
@section('title', 'Ubah Pemesanan Meeting')
        ...
        <div class="container-xl">
            <div class="row justify-content-center">
                <div class="col-xl-10 col-lg-10">
                    <form id="form_submit" action="{{ route('meeting.update', $meeting) }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="card">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <select name="id_ruang_meeting"
                                            ...
                                            @foreach (ruangMeeting() as $item)
                                                <option value="{{ $item->id }}" @selected(old('id_ruang_meeting') == $item->id || $meeting->id_ruang_meeting == $item->id)>
                                                    {{ $item->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="date" name="tanggal_meeting"
                                            ...
                                            value="{{ old('tanggal_meeting') ?? $meeting->tanggal_meeting }}" />
                                    ...
                                    <div class="col-md-9 col-12">
                                        <select name="id_waktu_meeting"
                                            ...
                                            @foreach (waktuMeeting() as $item)
                                                <option value="{{ $item->id }}" @selected(old('id_waktu_meeting') == $item->id || $meeting->id_waktu_meeting == $item->id)>
                                                    {{ $item->nama }}
                                                </option>
                                            @endforeach
                                        </select>
